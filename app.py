    ...
    if file:
        ...
        if "feedback" not in df.columns:
            ...
            if st.button("Process All"):
                ...
                # DASHBOARD INSIGHTS
                # ---------------------------
                st.subheader("📊 Batch Feedback Insights Dashboard")
                ...
                st.metric("Average Confidence", round(out_df["confidence"].mean(), 2))
                st.line_chart(out_df["confidence"])
    ...
    if file:
        ...
        if not all(col in df.columns for col in required):
            ...
            if st.button("Generate Digest"):
                ...
                # DASHBOARD INSIGHTS
                # ---------------------------
                st.subheader("📊 Weekly Feedback Insights Dashboard")
